...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "8b515676-0b13-43ab-a185-e2fceda7645a",
...
storage.mount('data', unstorage_47drivers_47fs_45lite({"driver":"fsLite","base":"/Users/nicolasmarcaud/Desktop/Learning-Projects/nuxt-3-nico/.data/kv"}));
...
const _lazy_pnC4Cz = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_pnC4Cz, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_pnC4Cz, lazy: true, middleware: false, method: undefined }
];
